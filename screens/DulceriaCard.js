...
export default function DulceriaCard({ titulo, precio, imagen }) {
  const navigation = useNavigation();

  return (
    <View style={{ marginBottom: 30, alignItems: "center", flex: 1 }}>
      <Pressable onPress={() => navigation.navigate("Personalizar")}>
        <Image source={imagen} style={{ width: 300, height: 220, borderRadius: 5 }} resizeMode="cover" />
      </Pressable>
      ...
      <View style={{ flexDirection: "row", marginTop: 10 }}>
        ...
        >
          <Text style={{color: 'black', fontWeight:900}}>{precio}</Text>
        </View>
      </View>
